...
class PaddingConfig{
  ...
  static double oneTwenty = SizeConfig.heightMultiplier * 14.7;/// 120/8.16
  static double oneNinety = SizeConfig.heightMultiplier * 23.28;/// 190/8.16
  static double fifty = SizeConfig.heightMultiplier * 6.12;/// 50/8.16
  static double ten = SizeConfig.heightMultiplier * 1.2;/// 10/8.16
  static double zero = SizeConfig.heightMultiplier * 0;/// 0
  static double three = SizeConfig.heightMultiplier * 0.37;/// 3/8.16
  static double six = SizeConfig.heightMultiplier * 0.735;/// 6/8.16
  static double one = SizeConfig.heightMultiplier/SizeConfig.heightMultiplier;///
  ...
  static double fourteen = SizeConfig.heightMultiplier * 1.71568627451;/// 14/8.16
  static double fifteen = SizeConfig.heightMultiplier * 1.83;/// 15/8.16
